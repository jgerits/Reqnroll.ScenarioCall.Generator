...
Scenario: Test Scenario";
    ...
    [InlineData("Gegeben sei ich habe etwas", "de-DE", true)]
    [InlineData("Wenn ich etwas mache", "de-DE", true)]
    [InlineData("Dann sehe ich etwas", "de-DE", true)]
    [InlineData("Und ich mache auch das", "de-DE", true)]
    [InlineData("Aber ich sehe das nicht", "de-DE", true)]
    [InlineData("Étant donné que j'ai quelque chose", "fr-FR", true)]
    [InlineData("Quand je fais quelque chose", "fr-FR", true)]
    [InlineData("Alors je vois quelque chose", "fr-FR", true)]
    [InlineData("Et je fais aussi cela", "fr-FR", true)]
    ...
    [InlineData(@"Gegeben sei I call scenario ""Login"" from feature ""Auth""", "de-DE", true)]
    [InlineData(@"Wenn I call scenario ""Login"" from feature ""Auth""", "de-DE", true)]
    [InlineData(@"Dann I call scenario ""Login"" from feature ""Auth""", "de-DE", true)]
    [InlineData(@"Und I call scenario ""Login"" from feature ""Auth""", "de-DE", true)]
    [InlineData(@"Aber I call scenario ""Login"" from feature ""Auth""", "de-DE", true)]
    [InlineData(@"Étant donné I call scenario ""Login"" from feature ""Auth""", "fr-FR", true)]
    [InlineData(@"Quand I call scenario ""Login"" from feature ""Auth""", "fr-FR", true)]
    [InlineData(@"Alors I call scenario ""Login"" from feature ""Auth""", "fr-FR", true)]
    [InlineData(@"Et I call scenario ""Login"" from feature ""Auth""", "fr-FR", true)]
    ...
    [InlineData(@"Gegeben sei I call scenario ""Anmeldung"" from feature ""Authentifizierung""", "de-DE", "Anmeldung", "Authentifizierung")]
    [InlineData(@"Quand I call scenario ""Connexion"" from feature ""Authentification""", "fr-FR", "Connexion", "Authentification")]
